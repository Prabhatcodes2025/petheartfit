...
function TrainingVideoItem({video}:{video:(typeof videos)[number]}){
 ...
 return <video ref={ref} muted loop playsInline preload="metadata" poster={video.poster} width="480" height="720" aria-label="Pawrexio training video"><source src={video.url} type="video/mp4"/></video>
}
