...
import { Booking, FAQPage, Legal, NotFound } from './pages/Pages'
import { About, Blog, BlogDetail, Gallery, LocationDetail, Locations, Testimonials } from './pages/ReferencePages'
